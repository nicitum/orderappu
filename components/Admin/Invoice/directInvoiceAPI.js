/**
 * Direct Invoice API - Handles creation and retrieval of direct invoices with collections data
 */

// Mock database query function (replace with actual database implementation)
const executeQuery = async (query, params) => {
  // This is a placeholder - replace with actual database query implementation
  console.log('Executing query:', query, 'with params:', params);
  return [];
};

// API to create direct invoice and insert products into order_products table
const createDirectInvoice = async (req, res) => {
    try {
        const { 
            invoice_number, 
            products, 
...
const fetchDirectInvoiceSummary = async (req, res) => {
    try {
